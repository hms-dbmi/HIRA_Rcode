...
# for testing purposes I change the original file name 코로나19 국제협력 연구_데이터 스키마 및 샘플 데이터
# to "HIRA_sampleDataUpdated" 

#corona claim data
co19_t200_trans_dn = read_excel("./Data/HIRA_sampleDataUpdated.xlsx", sheet=4)

#medical use history data
co19_t200_twjhe_dn = read_excel("./Data/HIRA_sampleDataUpdated.xlsx", sheet=8)
